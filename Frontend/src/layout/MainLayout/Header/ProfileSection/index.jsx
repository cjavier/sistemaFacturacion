...
const ProfileSection = () => {
  ...
  const handleLogout = async () => {
    ...
    // añadir una espera de 2 segundos
  ...
  useEffect(() => {
    ...
    if (token) {
      try {
        const decodedToken = jwtDecode(token); // Decodifica el token con jwt-decode
        if (decodedToken && decodedToken.email) {
          setUsername(decodedToken.email); // Extrae el nombre de usuario o email del token
        }
      } catch (error) {
                    ...
                    <Stack>
                      <Stack direction="row" spacing={0.5} alignItems="center">
                        ...
                        <Typography component="span" variant="h4" sx={{ fontWeight: 400 }}>
                          {username} {/* Mostramos el nombre del usuario extraído del JWT */}
                        </Typography>
                      </Stack>
                    </Stack>
                  </Box>
